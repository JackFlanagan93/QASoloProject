...
//		System.out.println(repo.getSingleRider(1));
	...
	public void createTeamTest() {
		Assert.assertEquals("{\"message\"; \"Team Has Been Succesfully Added To The System\"}", repo.createTeam("{\"teamID\":1,\"teamName\":\"testTeam\",\"motorcycleBrand\":\"testBrand\"}"));
	}
	
	@Test
	public void deleteTeamTest() {
		//False Condition
		Assert.assertEquals("{\"message\": \"Team Has NOT Been Succesfully Removed From The System\"}", repo.deleteTeam(1));
	}
	...
	public void updateTeamTest() {
		...
		Assert.assertEquals("{\"message\": \"Team Has Been Succesfully Updated\"}", repo.updateTeam(1, "{\"teamID\":1,\"teamName\":\"testTeam\",\"motorcycleBrand\":\"testBrand\"}"));
	...
	public void updateTeamTest2() {
		//False Condition
		Assert.assertEquals("{\"message\": \"Team Has NOT Been Succesfully Updated\"}", repo.updateTeam(1, "{\"teamID\":1,\"teamtwoName\":\"testTeam\",\"motorcycleBrand\":\"testBrand\"}"));
	}
